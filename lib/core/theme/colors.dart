...
class AppColors {
  ...
  static const Color onSurface = Color(0xFF000000,); // For text on surface color
  static const Color onSurfaceSecondary = Color(0xFF989898,); // For secondary text on surface color
